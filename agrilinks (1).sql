...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2025 at 05:57 PM
...
INSERT INTO `graded_batch` (`graded_batch_id`, `batch_id`, `inspector_id`, `inspection_date`, `freshness`, `weight`, `color`, `taste`, `shelf_life`, `grade`, `inspector`) VALUES
(1, 1, 4, '2025-01-20', 9, 1500.00, 'Red', 'Sweet', 30, 'A', NULL),
(2, 2, 4, '2025-02-14', 8, 1600.00, 'Orange', 'Sour', 25, 'B', NULL),
(3, 3, 4, '2025-03-05', 7, 1440.00, 'Yellow', 'Sweet', 20, 'C', NULL),
(4, 4, 4, '2025-03-27', 9, 2700.00, 'Red', 'Sweet', 15, 'A', NULL),
(5, 5, 4, '2025-04-10', 6, 5000.00, 'Brown', 'Earthy', 40, 'B', NULL),
(6, 6, 4, '2025-04-22', 8, 1440.00, 'Orange', 'Sweet', 30, 'A', NULL),
(7, 7, 4, '2025-05-07', 9, 1080.00, 'Green', 'Fresh', 20, 'A', NULL),
(8, 8, 4, '2025-05-18', 7, 5000.00, 'Brown', 'Tart', 35, 'C', NULL),
(9, 9, 4, '2025-06-08', 8, 6000.00, 'Green', 'Sweet', 45, 'A', NULL),
(10, 10, 4, '2025-06-15', 6, 1000.00, 'Red', 'Tart', 20, 'D', NULL),
(11, 11, 4, '2025-06-18', 9, 1125.00, 'Red', 'Sweet', 30, 'A', NULL),
(12, 12, 4, '2025-06-25', 8, 1800.00, 'Orange', 'Sweet', 25, 'B', NULL),
(13, 13, 4, '2025-07-02', 7, 1320.00, 'Yellow', 'Sweet', 30, 'C', NULL),
(14, 14, 4, '2025-07-05', 8, 3240.00, 'Red', 'Sweet', 40, 'A', NULL),
(15, 15, 4, '2025-07-08', 7, 1800.00, 'Orange', 'Sour', 30, 'B', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `graded_batches`
--

CREATE TABLE `graded_batches` (
  `id` int(11) NOT NULL,
  `batch_id` int(11) NOT NULL,
...
--
-- Dumping data for table `graded_batches`
--

INSERT INTO `graded_batches` (`id`, `batch_id`, `grade`, `graded_date`) VALUES
(1, 1, 'A', '2025-05-05'),
(2, 2, 'B', '2025-05-05'),
(3, 3, 'A', '2025-05-05'),
(4, 4, 'C', '2025-05-05');
...
--
-- Table structure for table `packaged_batch`
--

CREATE TABLE `packaged_batch` (
...
(6, 6, 1, 'Carrot', 120, 1440.00, 'Muntasir Rafin', 'Dhaka', 'Kolkata', 'In Transit', '2025-04-28 04:51:15', NULL),
(7, 7, 1, 'Cucumber', 90, 1080.00, 'Muntasir Rafin', 'Dhaka', 'Vola', 'Shipped', '2025-04-28 04:45:26', '2025-04-28 10:45:58'),
...
(3, 7, 2, 'rafin_driver', 'Dhaka', 'Vola', '2025-04-28 10:45:26', '2025-04-28 10:45:58');
...
INSERT INTO `transport_tracking` (`id`, `vehicle_id`, `latitude`, `longitude`, `timestamp`) VALUES
(1, 0, 23.8103, 90.4125, '2025-05-05 15:31:38');
...
--
-- Indexes for table `graded_batches`
--
ALTER TABLE `graded_batches`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `packaged_batch`
--
ALTER TABLE `packaged_batch`
...
--
-- Indexes for table `transport_tracking`
--
...
--
-- AUTO_INCREMENT for table `graded_batches`
--
ALTER TABLE `graded_batches`
...
--
-- AUTO_INCREMENT for table `packaged_batch`
--
ALTER TABLE `packaged_batch`
...
--
-- AUTO_INCREMENT for table `transport_tracking`
--
ALTER TABLE `transport_tracking`
...
--
-- Constraints for table `packaged_batch`
--
ALTER TABLE `packaged_batch`
  ADD CONSTRAINT `packaged_batch_ibfk_1` FOREIGN KEY (`batch_id`) REFERENCES `graded_batch` (`batch_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `transport`
  ADD CONSTRAINT `transport_ibfk_1` FOREIGN KEY (`package_id`) REFERENCES `packaged_batch` (`package_id`) ON DELETE CASCADE;
COMMIT;
